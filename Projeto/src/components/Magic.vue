<template>
  <div className="p-3 mb-2 bg-light text-dark container">
    ...
    <button className="btn btn-primary" v-for="(option, index) in options" :key="index"
      ...
      {{ option.index }}
        ...
        <div className="p-3 mb-2 bg-light text-dark">
         <Statement
          v-bind="options[currentTabIndex]"
